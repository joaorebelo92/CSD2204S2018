...
MariaDB [csd2204s18]> SELECT products.code, products.name, manu.name FROM manu INNER JOIN products ON poducts.code = manu.code;
ERROR 1054 (42S22): Unknown column 'poducts.code' in 'on clause'
MariaDB [csd2204s18]> SELECT products.code, products.name, manu.name FROM manu INNER JOIN products ON products.code = manu.code;
+------+-----------------+-------------------+
| code | name            | name              |
+------+-----------------+-------------------+
|    1 | Hard drive      | Sony              |
...
MariaDB [csd2204s18]> SELECT manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer WHERE manufacturer < 4 GROUP BY manufacturer;
+--------------+-----------------+-----------------------+
| manufacturer | name            | No. of items produced |
+--------------+-----------------+-----------------------+
|            1 | Sony            |                     1 |
...
MariaDB [csd2204s18]> SELECT manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer WHERE m.code < 4 GROUP BY manufacturer;
+--------------+-----------------+-----------------------+
| manufacturer | name            | No. of items produced |
+--------------+-----------------+-----------------------+
|            1 | Sony            |                     1 |
...
MariaDB [csd2204s18]> SELECT manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer 4 GROUP BY manufacturer HAVING COUNT(*) > 2;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '4 GROUP BY manufacturer HAVING COUNT(*) > 2' at line 1
MariaDB [csd2204s18]> SELECT manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer WHERE Count(*) > 2 GROUP BY manufacturer;
ERROR 1111 (HY000): Invalid use of group function
MariaDB [csd2204s18]> SELECT manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer 4 GROUP BY manufacturer HAVING COUNT(*) > 2;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '4 GROUP BY manufacturer HAVING COUNT(*) > 2' at line 1
MariaDB [csd2204s18]> SELECT manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer GROUP BY manufacturer HAVING COUNT(*) > 2;
+--------------+-------------------+-----------------------+
| manufacturer | name              | No. of items produced |
+--------------+-------------------+-----------------------+
|            2 | Creative Labs     |                     3 |
...
MariaDB [csd2204s18]> SELECT manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer WHERE m.code IN (2,3)  GROUP BY manufacturer;
+--------------+-----------------+-----------------------+
| manufacturer | name            | No. of items produced |
+--------------+-----------------+-----------------------+
|            2 | Creative Labs   |                     3 |
...
MariaDB [csd2204s18]> SELECT products.code, products.name, manu.name FROM manu LEFT JOIN products ON products.manufacturer = manu.code;
+------+-----------------+-------------------+
| code | name            | name              |
+------+-----------------+-------------------+
|    5 | Monitor         | Sony              |
